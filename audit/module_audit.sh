...
FUNCTIONS=(
  ...
  [drupal_encode_path]="Namespace: use \Drupal\Component\Utility\UrlHelper; / UrlHelper::encodePath('drupal');"
  ...
  [drupal_get_query_array]="Namespace: use \Drupal\Component\Utility\UrlHelper; / parse_str('foo=bar&bar=baz', \$query_array);"
  [drupal_get_query_parameters]="Namespace: use \Drupal\Component\Utility\UrlHelper; / UrlHelper::filterQueryParameters('foo=bar&bar=baz');"
  ...
  [filter_xss_bad_protocol]="Namespace: use \Drupal\Component\Utility\UrlHelper; / UrlHelper::filterBadProtocol('javascript://example.com?foo&bar');"
  ...
  [url_is_external]="Namespace: use \Drupal\Component\Utility\UrlHelper; / UrlHelper::isExternal('http://drupal.org');"
