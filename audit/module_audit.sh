...
FUNCTIONS=(
  ...
  [drupal_get_schema]="In .install: \$schema = drupal_get_schema_unprocessed(\$module, \$table); / There's no API for getting the schema of an entity table."
  ...
  [element_info]="\Drupal::ElementInfo()->getInfo()"
  [element_info_property]="\Drupal::ElementInfo()->getInfoProperty()"
  ...
  [entity_load]="\Drupal::entityManager()->getStorage(\$entity)->load(\$id);"
  ...
  [system_rebuild_theme_data]="$theme_handler->rebuildThemeData()"
  [t]="\$this->t('some text')"
  ...
  [_update_create_fetch_task]="\Drupal::service('update.processor')->createFetchTask(\$project);"
  [_update_process_fetch_task]="\Drupal::service('update.processor')->processFetchTask(\$project);"
  [_update_refresh]="\Drupal::service('update.manager')->refreshUpdateData();"
  [update_fetch_data]="\Drupal::service('update.processor')->fetchData();"
  [update_fetch_data_finished]="\Drupal::service('update.manager')->fetchDataBatch(\$context);"
  [update_get_projects]="\$projects = \Drupal::service('update.manager')->getProjects();"
  [update_manual_status]="\Drupal\update\Controller\UpdateController::updateStatusManually();"
  ...
  [user_load]="\Drupal::entityManager()->getStorage('user')->load(\$id);"
